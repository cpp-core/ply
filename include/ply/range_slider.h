...
struct SliderYAxis : Member<SliderYAxis, list<SliderRangeMode>>, Range<SliderYAxis>, virtual Data
{ };
...
struct RangeSlider : Member<RangeSlider,list<SliderYAxis>>, Range<RangeSlider>, virtual Data
{
